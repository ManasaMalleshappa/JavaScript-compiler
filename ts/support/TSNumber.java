 ...
 * <a href="http://www.ecma-international.org/ecma-262/5.1/#sec-8.5">ELS 5.1</a>
 * ).
 */
public final class TSNumber extends TSPrimitive {
	 ...
	 *
	 * @param value
	 *            the Java double to be encapsulated by the TSNumber
	...
	public TSString toStr() {
		...
		if (Double.isInfinite(temp)) {
			...
			String tmp = String.format("%.16e", temp);
			byte buf[] = tmp.getBytes();
			byte out[] = new byte[tmp.length()];

			// 'e' will be at offset 18
			int p = 18;
	...
	public TSBoolean toBoolean() {
		...
		if (value == 0 || value == -0 || value == Double.NaN) {
